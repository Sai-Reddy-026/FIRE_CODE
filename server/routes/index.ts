...
import { runCodeRateLimiter } from "../middlewares/security";

const router = express.Router();

// Direct raw code execution endpoint for Judge0 CE (POST /api/run)
router.post("/run", runCodeRateLimiter as express.RequestHandler, asyncHandler(ProblemController.runDirectCode) as express.RequestHandler);
